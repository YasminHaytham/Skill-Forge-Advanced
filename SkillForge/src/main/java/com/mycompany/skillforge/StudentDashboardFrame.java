...
public class StudentDashboardFrame extends javax.swing.JFrame {
    ...
    private void LessonFrameBtnActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_LessonFrameBtnActionPerformed
        ...
        if (selected != -1) {
            Lesson selectedLesson = Student.getEnrolledCourseObjects().get(EnrolledCoursesList.getSelectedIndex())
                    .getLessons().get(selected);
            Student.addLessonProgress(
                    Student.getEnrolledCourseObjects().get(EnrolledCoursesList.getSelectedIndex()).getCourseId(),
